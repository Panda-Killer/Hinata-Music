...
BOT_TOKEN = getenv("7647380005:AAH8VSJoRI_tsNbGzh3YIPDb9SpQ1w71Xa8")
...
LOG_GROUP_ID = int(getenv("-1002147955274", None))

# Get this value from @MissRose_Bot on Telegram by /id
OWNER_ID = int(getenv("5629555417", None))
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/Hyuga_updates")
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/HyugaSupport")
